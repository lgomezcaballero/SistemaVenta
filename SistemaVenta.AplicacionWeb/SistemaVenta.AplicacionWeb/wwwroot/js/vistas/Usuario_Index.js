        ...
        fetch("/Usuario/Crear", {
            ...
            .then(responseJson => {
                ...
                if (responseJson.estado) {
                    ...
                    swal("Listo!", "El user was created", "success")
                } else {
        ...
        fetch("/Usuario/Editar", {
            ...
            .then(responseJson => {
                ...
                if (responseJson.estado) {
                    ...
                    $("#modalData").modal("hide")
                    swal("Ready!", "The User was modified", "success")
                } else {
                    swal("Sorry", responseJson.mensaje, "error")
                }
            })
...
$("#tbdata tbody").on("click", ".btn-eliminar", function () {
    ...
    swal({
        title: "¿Are you sure?",
        text: `Deleted the user "${data.nombre}"`,
        type: "warning",
                ...
                fetch(`/Usuario/Eliminar?IdUsuario=${data.idUsuario}`, {
                    ...
                    .then(responseJson => {
                        ...
                        if (responseJson.estado) {
                            ...
                            swal("Ready!", "The user was deleted", "success")
                        } else {
                            swal("Sorry", responseJson.mensaje, "error")
                        }
                    })
